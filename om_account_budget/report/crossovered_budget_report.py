...
class budget_report(models.AbstractModel):
    _name = 'report.om_account_budget.report_crossoveredbudget'
    ...
    def funct(self, object, form, ids=None, done=None, level=1):
        ...
        budgets = self.env['crossovered.budget'].browse([object.id])
        ...
        for budget_id in budgets:
            ...
            for i in range(0, len(an_ids)):
                ...
                line_ids = c_b_lines_obj.search([('id', 'in', budget_ids), ('analytic_account_id','=',an_ids[i][0]), ('date_to', '>=', d_from), ('date_from', '<=', d_to)])
