...
class CustomerPortal(CustomerPortal):
    ...
    def account(self, redirect=None, **post):
        ...
        response = request.render("crmfront.portal_my_details", values)
    ...
    def contactus_form(self, redirect=None, **post):
        ...
        if post and request.httprequest.method == 'POST':
            error_message = False
            if post['name'] == '' or post['email'] == '' or post['phone'] == '' or post['subject'] == '' or post['service'] == '' or post['comment'] == '':
        ...
        response = request.render("crmfront.portal_contactus", values)
        response.headers['X-Frame-Options'] = 'DENY'
        return response
