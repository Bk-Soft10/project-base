...
export class MessengerScriptStepsOne2manyRenderer extends ListRenderer {
    /**
...
export class MessengerScriptStepsOne2many extends X2ManyField {
    static components = {
        ...X2ManyField.components,
        ListRenderer: MessengerScriptStepsOne2manyRenderer,
    };
    /**
...
export const messengerScriptStepsOne2many = {
    ...x2ManyField,
    component: MessengerScriptStepsOne2many,
};

fieldRegistry.add("messenger_script_steps_one2many", messengerScriptStepsOne2many);
